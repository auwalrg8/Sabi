class ConnectionDetails {
  ...
  factory ConnectionDetails.fromJson(Map<String, dynamic> json) {
    return ConnectionDetails(
      ...
      initializedAt: json['initialized_at'] != null ? DateTime.parse(json['initialized_at'] as String) : null,
    );
  }
...
class WalletModel {
  ...
  factory WalletModel.fromJson(Map<String, dynamic> json) {
    ...
    return WalletModel(
      ...
      balanceSats: (json['balance_sats'] is int) ? json['balance_sats'] as int : int.tryParse((json['balance_sats'] ?? '0').toString()) ?? 0,
      balanceNgn: json['balance_ngn'] != null ? (json['balance_ngn'] is num ? (json['balance_ngn'] as num).toDouble() : double.tryParse(json['balance_ngn'].toString())) : null,
      connectionDetails: conn is Map<String, dynamic> ? ConnectionDetails.fromJson(conn) : null,
